...
*Responses*:  These are all the actions that the entities can take.  For example, a user can complete a profile questionaire. Each response should have a value associated with it.

*Values*:     This is the abstract value associated with strategies and responses.  For example, email could have a value of -1, and a completed profile could have a value of 2. Good things should be positive, bad things should be negative.
